(function() {
	...
	function ApplicationInstancesController($location, $scope, Principal,
		...
		function loadReference(id) {
			ApplicationInstances.references({
				id : id
			}, function(result) {
				for (var i = 0; i < result.length; i++) {
					for (var j = 0; j < vm.measureInstances.length; j++) {
		...
		function isShedule(id) {
			ApplicationInstances.isShedule({
				id : id
			}, function(result) {
				for (var i = 0; i < vm.measureInstances.length; i++) {
		...
		function loadDefaultViewStatus(id){
			ApplicationInstances.getDefaultVisualisation({
				id : id
			}, function(result) {
				for (var j = 0; j < vm.measureInstances.length; j++) {
					if (vm.measureInstances[j].id == id) {
		...
		function createView(id) {
			ApplicationInstances.createDefaultVisualisation(
			{
				id : id
			},
			function(result) {
		...
		function deleteView(id) {
			ApplicationInstances.deleteDefaultVisualisation(
			{
				id : id
			},
			function(result) {
